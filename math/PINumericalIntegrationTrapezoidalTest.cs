...
namespace pi.science.math.test {
  ...
  /// <summary>
  /// Test class for <see cref="pi.science.math.PINumericalIntegrationTrapezoidal"/>.
  /// </summary>

  [TestClass]
  public class PINumericalIntegrationTrapezoidalTest {

    [TestMethod]
    public void TestMethod() {

      PIDebug.TitleBig( "Numeric integration - Trapezoidal method" );

      PIDebug.TitleBig( "Sin(x)^2 from 0..PI" );

      #pragma warning disable IDE0017 // Simplify object initialization
      PINumericalIntegrationTrapezoidal integration = new PINumericalIntegrationTrapezoidal( 0, Math.PI );
      ...
      Assert.AreEqual( 1.1487, value, 0.0001 );
      Console.WriteLine( value );
