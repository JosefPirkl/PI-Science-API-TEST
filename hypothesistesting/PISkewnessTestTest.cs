...
namespace pi.science.hypothesistesting.test {
  ...
  /// <summary>
  /// Test class <see cref="pi.science.hypothesistesting.PISkewnessTest"/>.
  /// </summary>

  [TestClass]
  public class PISkewnessTestTest {
    ...
    public void TestMethod() {
      ...
      PIDebug.TitleBig( "Skewness test of normality, 9D7" );
      ...
      Assert.AreEqual( 0.3392, test.PValue, 0.001 );            
      
      /* Data source 9D4/2. This test with Shapiro-Wilk (expanded) rejects normality, try it with this skewness test. */

      PIDebug.TitleBig( "Skewness test of normality, data from 9D4,2", true );

      PIVariable var1 = new PIVariable();
      var1.AddValues( new int[] { 12, 27, 18, 23, 72, 27, 27, 53, 3, 45, 53, 125, 50 } );

      PISkewnessTest test1 = new PISkewnessTest( var1 );
